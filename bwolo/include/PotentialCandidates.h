...
#ifndef POTENTIALCANDIDATES_H_
#define POTENTIALCANDIDATES_H_
...
#include "candidate.h"
typedef String<String<String<candidate::Candidate> > > PotentialCandidates;
#endif /* POTENTIALCANDIDATES_H_ */
